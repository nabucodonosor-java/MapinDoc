...
import com.mapin.docmapin.services.SpecializationService;
...
public class SpecializationController {
	...
	@PostMapping
	public ResponseEntity<SpecializationDto> insert(@Valid @RequestBody SpecializationDto dto) {
	...
	@PutMapping("/{id}")
	public ResponseEntity<SpecializationDto> update(@PathVariable Long id, @Valid @RequestBody SpecializationDto dto) {
